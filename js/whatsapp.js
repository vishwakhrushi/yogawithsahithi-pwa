...
const WA_TEMPLATES = [
  ...
  },
  {
    ...
    params: ["name", "batchType", "startDate", "classDays", "classTime",
             "zoomLink", "meetingId", "passcode", "recordingsLink"],
    labels: ["Student Name", "Batch Type", "Start Date (DD/MM/YYYY)", "Class Days",
             "Class Time", "Zoom Link", "Meeting ID", "Passcode", "Recordings Link"],
    hasDietButton: true,
  },
  {
...
function renderTemplateParams(formId, templateName, student, batch) {
  ...
  const prefill = {
    ...
    batchType:      batch   ? batch.batchType     : "",
